...
# Split fmri_train data
train00_fmri = train_fmri[:300]
train01_fmri = train_fmri[300:600]
train02_fmri = train_fmri[600:900]
train03_fmri = train_fmri[900:1200]
train04_fmri = train_fmri[1200:1500]
train05_fmri = train_fmri[1500:1800]
train06_fmri = train_fmri[1800:2100]
train07_fmri = train_fmri[2100:2400]
train08_fmri = train_fmri[2400:2700]
train09_fmri = train_fmri[2700:3000]
train10_fmri = train_fmri[3000:3300]
train11_fmri = train_fmri[3300:3600]
...
# Find held out data
hold_out_fmri = scan + "_fmri"
hold_out_features = scan

# Remove held out
fmri_arrays.remove(hold_out_fmri)
feature_arrays.remove(hold_out_features)
...
np.save('results/movie/' + subject + '_' + scan + '_best_alphas.npy', best_alphas)
np.save('results/movie/' + subject + '_' + scan + '_coefficients.npy', average_coef)
