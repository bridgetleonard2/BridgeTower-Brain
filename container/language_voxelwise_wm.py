...
# Prep data
alternateithicatom_fmri, alternateithicatom_features = prep_data(fmri_alternateithicatom, alternateithicatom)
...
fmri_arrays = [alternateithicatom_fmri, avatar_fmri, howtodraw_fmri, legacy_fmri,
               life_fmri, yankees_fmri, naked_fmri,
               odetostepfather_fmri, souls_fmri, undertheinfluence_fmri]
feature_arrays = [alternateithicatom_features, avatar_features, howtodraw_features,
...
hold_out_features = scan + "_features"
...
np.save('results/story/' + subject + '_' + scan + '_best_alphas.npy', best_alphas)
np.save('results/story/' + subject + '_' + scan + '_coefficients.npy', average_coef)
